...
class WorkflowTests(unittest.TestCase):
    def test_compile_nested_block(self):
        block = step('Compile ImmortalWrt')['run']
    ...
    def test_download_gates_and_pack(self):
        ...
        self.assertLess(STEPS.index(snapshot), STEPS.index(step('Prepare ImmortalWrt source')))
        self.assertLess(STEPS.index(step('Compile ImmortalWrt')), STEPS.index(check))
